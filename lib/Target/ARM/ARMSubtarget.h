...
public:
  ...
  // Darwin uses SjLj. Symbian uses DRAWF. Other targets might need more checks.
  bool isTargetEHABICompatible() const {
    return (TargetTriple.getEnvironment() == Triple::EABI ||
            ...
            isTargetAndroid()) &&
           !isTargetDarwin() && !isTargetWindows() &&
           !(isTargetSymbian() && (TargetTriple.getOSMajorVersion() >= 9 || 
  ...
  bool isTargetSymbian() const { return TargetTriple.isSymbian(); }
